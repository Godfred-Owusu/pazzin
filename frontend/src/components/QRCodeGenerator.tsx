...
//       try {
//         const response = await axios.get("http://172.20.10.2:3000/programs");
...
//     try {
//       await axios.post("http://172.20.10.2:3000/participants/register", {
//         name: userData.name,
//         email: userData.email,
//         phone: userData.phone,
//         // programId: userData.programId,
      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="max-w-md mx-auto">
          <Card className="bg-gradient-card border-border/50 shadow-card-custom animate-scale-in">
            ...
            <CardContent>
              <QRCodeForm onSubmit={handleRegister} isLoading={isLoading} />
            </CardContent>
          </Card>
        </div>
      </div>
