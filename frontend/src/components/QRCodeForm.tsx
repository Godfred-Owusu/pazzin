...
export const QRCodeForm = ({ onSubmit, isLoading, disabled, programs, programsLoading }: QRCodeFormProps) => {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        >
          ...
          >
            <SelectValue placeholder={programsLoading ? "Loading programs..." : "Select your program"} />
          </SelectTrigger>
        ...
        {errors.programId && (
          <p className="text-sm text-destructive animate-fade-in">{errors.programId}</p>
        )}
      </div>
